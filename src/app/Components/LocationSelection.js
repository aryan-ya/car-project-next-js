...
//locationdata location selection  next jd

const locations =[
   "New Delhi123 INDIA",
   "UttarPradesh456 LUCKNOW",
   "Bihar789  Patna",
  ...
  return (
    <Menu as='div' className='w-full h-full flex xl:flex-row'>
       <div className="relative flex-1">
        ...
        <Menu.Button className="dropdown-btn w-full h-full flex flex-col justify-center items-center xl:items-start xl:pl-8">
         <div className="w-full h-16 xl:h-full flex justify-center xl:justify-start xl:border-r xl:border-black/10">
          ...
          <div className="flex flex-col xl:flex-row items-center xl:gap-x-2 gap-y-2 xl:gap-y-0"><FaMapMarkerAlt className="text-accent" />
      ...
      {locations.map((location, index) =>{
            ...
            className="cursor-pointer py-4 xl:pl-10 hover:bg-gray-50 text-[13px] uppercase" key={index}>{location}</div>
      })}
        </Menu.Items>
